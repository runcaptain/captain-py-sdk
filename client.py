...
class RuncaptainApi:
    ...
    environment : RuncaptainApiEnvironment
        The environment to use for requests from the client. from .environment import RuncaptainApiEnvironment



        Defaults to RuncaptainApiEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: RuncaptainApiEnvironment = RuncaptainApiEnvironment.DEFAULT,
        authorization: str,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: RuncaptainApiEnvironment) -> str:
