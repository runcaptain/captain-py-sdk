...
from .types.query_request_v2model_id import QueryRequestV2ModelId
...
class QueryClient:
    ...
    def collection_v2(
        ...
        *,
        ...
        model_id: typing.Optional[QueryRequestV2ModelId] = OMIT,
        ...
        model_id : typing.Optional[QueryRequestV2ModelId]
